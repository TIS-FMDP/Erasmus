                ...
                '<tr class="' . $row_bg . '">
                    ...
                    <td>
                        ...
                        <div class="btns-group">
                            <a href="?m=app_list?m=application_edit&id=' . $row['ID'] . '" class="green">
                                <i class="fa fa-pencil-square-o"></i>
                            </a>
                            <a href="?m=app_list?m=application_preview&id=' . $row['ID'] . '" class="blue">
...
function tryDelete(id) {
    ...
    if (del) {
        window.location.replace("?m=app_list?m=application_del&id=" + id);
    }
}    
...
$(document).ready(function(){
    ...
    $('.show-btns').dblclick(function(event) {
        event.preventDefault();
        window.location.replace("?m=app_list?m=application_edit&id=" + $(this).attr('cId'));
        console.log('FUCK');
    });    
});
</script>
